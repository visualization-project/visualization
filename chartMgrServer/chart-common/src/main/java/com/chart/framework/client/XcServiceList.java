package com.chart.framework.client;
...
public class XcServiceList {
    ...
    public static final String XC_SERVICE_MANAGE_COURSE = "xc-service-charting-course";
    public static final String XC_SERVICE_MANAGE_MEDIA = "xc-service-charting-media";
    public static final String XC_SERVICE_MANAGE_CMS = "xc-service-charting-cms";
    ...
    public static final String XC_SERVICE_MANAGE_ORDER = "xc-service-charting-order";
